...
import image from "../../assets/img/url-bg.jpg";
        ...
        <div className={"relative"}>
            <div className="bg-[#14344C]/60 h-screen py-10 font-serif min-h-screen max-h-screen overflow-auto">
                ...
                <section className="my-7">
                    <form action="" className="w-[90%] md:w-[60%] lg:w-[40%] transition-all duration-500 mx-auto bg-white/90 rounded-xl p-6">
                        {authScreenToShow === "create account" ? (
                            ...
                            <div className={"text-center text-sm text-red-500"}>{loginError && `-- ${loginError} --`}</div>
                            <label htmlFor="" className="block">
                                Email<span className={`${email === "" ? "" : "hidden"} text-md text-red-500`}>*</span>
                            </label>
                            <input
                                type="email"
                                required
                            ...
                            />
                            <label htmlFor="" className="block mt-2">
                                Password<span className={`${password === "" ? "" : "hidden"} text-md text-red-500`}>*</span>
                            </label>
                            <input
                                type="password"
                                required
                            ...
                            <p>
                                ...
                                <span
                                    ...
                                    className="underline text-blue-500 cursor-pointer">Create Account
                                    </span>
                                {"."}
                            </p>
                            <p>
                                <span
                                    ...
                                    className="underline text-blue-500 cursor-pointer">Forgot Password
                                </span>
                                {"?"}
                            </p>
            ...
            <div className="absolute -z-10 top-0 left-0">
                <Image src={image} alt={"talosmart"} className="h-screen w-screen"/>
            </div>
        </div>
    );
};
